      ...
      include: [
        {
          ...
          include: [
            {
              model: Contourage,
              attributes: ["id", "date", "etat", "remarque"],
            },
            {
              model: Dosimetrie,
              attributes: ["id", "date", "etat", "remarque"],
            ...
            {
              model: Seance,
              attributes: ["id", "date", "etat", "numero_seance"],
            },

            {
              model: CentreTraitement,
              attributes: ["id", "nom", "localisation", "mail", "numTel"],
            },
          ],
        },
      ],
  ...
  try {
    ...
    const patientWithDetails = await Patient.findByPk(patientId, {
      include: [
        {
          model: Traitement,
          attributes: ["id", "nombreSeances", "dateDebut", "etalement"],
          include: [
            {
              model: Contourage,
              attributes: ["id", "date", "etat", "remarque"],
      ...
      include: [
        {
          ...
          include: [
            ...
            { model: Qualite, attributes: ["id", "date", "etat", "remarque"] },

            {
              ...
              include: [{ model: Machine, attributes: ["id", "nomMachine"] }],
            },
            {
              model: Prescription,
              attributes: [
